...
loaded_lib = tvm.module.load('./export/net1_android.tar')
# json graph
loaded_json = open("./export/net1_android").read()
# parameters in binary
loaded_params = bytearray(open("./export/net1_android.params", "rb").read())
